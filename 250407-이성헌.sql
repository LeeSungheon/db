...
select empno,ename,sal from emp where hiredate LIKE'%80%';
select empno,ename,sal from emp where ename LIKE'__AR%';
select empno,ename,sal from emp where hiredate >'81-01-01'and sal >=3000;
select empno,ename,sal from emp where hiredate >'82-01-01'or sal >=3000;
