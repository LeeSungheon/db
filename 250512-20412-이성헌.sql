...
select empo,ename ,sal ,comm,NVL2(comm , sal+comm,sal*0)"NVL2"
from emp
where deptno = 30;

select deptno ,name ,DECODE(deptno, 101,'Computer Engineering')"DNAME"from professor;

select empno ,enaame,sal,
       case when sal between 1 and 1000 then 'level 1'
       case sal between 1001 and 2000 then 'level 2'
       case sal between 2001 and 3000 then 'level 3'
       case sal between 3001 and 4000 then 'level 4'
       else'level 5'
    end "LEVEL"
       from emp;
