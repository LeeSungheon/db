...
insert into book values(5,'생활',4,12000,'2021-01-10');
...
select BOOK_ID AS 도서_ID,PUBLISHED_DATE 출판일
FROM BOOK
WHERE CATEGORY = '경제'AND TO_CHAR(PUBLISHED_DATE,'YYYY')='2021'
ORDER BY PUBLISHED_DATE ASC;

SELECT b.BOOK_ID AS 도서_ID, a.AUTHOR_NAME AS 저자명_NAME, PUBLISHED_DATE AS 출판일_DATE
